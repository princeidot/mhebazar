...
<head>
    ...
    <title>Dashboard Sell Your Old Product </title>
        ...
        <section class="bgcolor">
            <div class="container pt-5 pb-5">
                <div class="tabuser bg-white">
                    <div class="title">Sell Your Old Product<span class="right"><a href="{{ route('sell') }}"
                                class="back-btn btn btn-primary">list New Product</a><a href="{{ route('account') }}"
                                        ...
                                        <div class="information">
                                            ...
                                            <div class="" id="user_info">
                                                ...
                                                <div id="show2" class="myDiv">
                                                    <form method="post" action="{{ route('addoldproduct') }}"
                                                        ...
                                                        <table>
                                                            <tbody>
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                       <input type="text" name="title"
                                                                            ...
                                                                            value="{{ old('title') }}" required onkeypress="return((event.charCode > 64 && event.charCode < 91) || (event.charCode > 96 && event.charCode < 123) || event.charCode == 8 || event.charCode == 32 || (event.charCode >= 48 && event.charCode <= 57));">
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <textarea name="description" class="form-control @error('description') is-invalid @enderror"
                                                                            value="{{ old('description') }}" rows="4" style="font-size: 100%;" required></textarea>
                                                                    </td>
                                                                ...
                                                                <tr>
                                                                    <td>Manufacturer of Company*</td>
                                                                    <td><input type="text" name="manufacturer"
                                                                            class="form-control @error('manufacturer') is-invalid @enderror"
                                                                            value="{{ old('manufacturer') }}" required></td>
                                                                </tr>
                                                                <tr>
                                                                    <td>Manufacturer Year</td>
                                                                    <td><input type="text" name="manufacturer_y"
                                                                            class="form-control @error('manufacturer_y') is-invalid @enderror"
                                                                            value="{{ old('manufacturer_y') }}" required></td>
                                                                </tr>
                                                                <tr>
                                                                    <td>Model*</td>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td><input type="text" name="capacity"
                                                                            ...
                                                                            value="{{ old('capacity') }}" required></td>
                                                                </tr>
                                                                <tr>
                                                                    <td>Operator Type</td>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <input type="file" name="image"
                                                                            class="form-control image" required id="image">
																		<label for="image">(Image dimensions 1080px*1080px)</label>
                                                                        ...
                                                                        <div class="upload__box">
                                                                            <div class="upload__btn-box">
                                                                                ...
                                                                                <input type="file" multiple=""
                                                                                    name="images[]"
                                                                                    data-max_length="20"
                                                                                    class="upload__inputfile form-control" id="images">
																				 <label for="images">(All Images dimensions 1080px*1080px)</label> 
                                                        ...
                                                        <table>
                                                            <tbody>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <textarea name="ldescription" class="form-control @error('ldescription') is-invalid @enderror"
                                                                            value="{{ old('ldescription') }}" rows="4" style="font-size: 100%;" reuired></textarea>
                                                                    </td>
                                                        ...
                                                        <table>
                                                            <tbody>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td><input type="text" name="manufacturer"
                                                                            class="form-control @error('manufacturer') is-invalid @enderror"
                                                                            value="{{ old('manufacturer') }}" reuired></td>
                                                                </tr>
                                                                <tr>
                                                                    <td>Manufacturer Year*</td>
                                                                    <td><input type="text" name="manufacturer_y"
                                                                            class="form-control @error('manufacturer_y') is-invalid @enderror"
                                                                            value="{{ old('manufacturer_y') }}" reuired></td>
                                                                </tr>
                                                                <tr>
                                                                    <td>Model*</td>
                                                                    <td><input type="text" name="model"
                                                        ...
                                                        <table>
                                                            <tbody>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <textarea name="ldescription" class="form-control @error('ldescription') is-invalid @enderror"
                                                                            value="{{ old('ldescription') }}" rows="4" style="font-size: 100%;"></textarea>
                                                                    </td>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td><input type="text"
                                                                            ...
                                                                            value="{{ old('rated_towing_ability') }}"></td>
                                                                </tr>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td><input type="text"
                                                                            ...
                                                                            value="{{ old('max_towing_capacity') }}"></td>
                                                                </tr>
                                                                {{-- <tr>
                                                                    ...
                                                                    <li class="list-inline-item">
                                                                        ...
                                                                        <form action="{{route('product.delete',$prod->id)}}" method="post">
                                                                            ...
                                                                            <input name="_method" type="hidden"
                                                                                value="DELETE">
                                                                                <button type="submit"
                                                                            class="btn btn-danger deleteUser btn-sm rounded-0"
                                                                            type="button" title="Delete"><i
                                                                                class="fa fa-trash"></i></button>
