                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header card-header-rose card-header-icon">
                                    ...
                                    <h4 class="card-title">Users <a href="{{ url()->previous() }}"><button class="btn btn-success btn-round" style="float:right">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="td-actions text-right">
                                                            <button type="button" rel="tooltip" class="btn btn-info">
                                                                <a href="{{ route('dashboard.userproduct', ['id' => $cform->userid]) }}"
                                                                    class="text-white"> <i
                                                            ...
                                                            <button type="button" rel="tooltip"
                                                                ...
                                                                <a href="javascript:void(0)" id="show-user"
                                                                    data-id="{{ $cform->id }}" data-toggle="modal"
                                                                    data-target="#myModal">
