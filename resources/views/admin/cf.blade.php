                                    ...
                                    <div class="table-responsive">
                                        <table class="table">
                                            ...
                                            <tbody>
                                                ...
                                                @foreach ($getdata as $key => $cform)
                                                    <tr>
                                                        <td class="text-center">
                                                            {{-- {{ $loop->iteration }} --}}

                                                            {{ $key + $getdata->firstItem() }}
                                                        </td>
                                                        <td>{{ $cform->name }}</td>
                                                        <td>{{ $cform->email }}</td>
                                                        <td>{{ $cform->no }}</td>
                                                        <td class="text-right">{{ $cform->cname }}</td>
                                                        <td class="text-right">{{ $cform->pname }}</td>
                                                        ...
                                                        <td class="td-actions text-right">
                                                            ...
                                                            <form method="POST"
                                                                action="{{ route('proqf.delete', $cform->id) }}">
                                                                @csrf
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header card-header-rose card-header-icon">
                                    ...
                                    <h4 class="card-title">Rent/Buy Product Quote form</h4>
                                </div>
                                <div class="card-body">
                                    <div class="table-responsive">
                                        <table class="table">
                                                ...
                                                @foreach ($rentb as $key => $cform)
                                                    <tr>
                                                        ...
                                                        <td class="td-actions text-right">
                                                            ...
                                                            <form method="POST"
                                                                action="{{ route('rbf.delete', $cform->id) }}">
                                                                @csrf
                                                                <input name="_method" type="hidden" value="DELETE">
                                                                <button type="button" rel="tooltip"
                                                                    class="btn btn-danger show_confirm">
                                        ...
                                        {{ $rentb->links('pagination::bootstrap-4') }}
                                    ...
                                    <div class="table-responsive">
                                        <table class="table">
                                            ...
                                            <tbody>
                                                ...
                                                @foreach ($contact as $key => $cform)
                                                    <tr>
                                                        <td class="text-center">
                                                            {{-- {{ $loop->iteration }} --}}

                                                            {{ $key + $contact->firstItem() }}
                                                        </td>
                                                        <td>{{ $cform->name }}</td>
                                                        <td>{{ $cform->email }}</td>
                                                        <td>{{ $cform->mno }}</td>
                                                        <td class="text-right">{{ $cform->megg }}</td>
                                                        ...
                                                        <td class="td-actions text-right">
                                                            ...
                                                            <form method="POST"
                                                                action="{{ route('contact.delete', $cform->id) }}">
                                                                @csrf
                                                                <input name="_method" type="hidden" value="DELETE">
                                                                <button type="button" rel="tooltip"
                                                                    class="btn btn-danger show_confirm">
