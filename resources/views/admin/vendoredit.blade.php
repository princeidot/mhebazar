                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <form action="{{ route('dashboard.updatedetails', $maincate->id) }}"
                                            method="post" enctype="multipart/form-data">
                                            @csrf
                                            <input type="hidden" name="userid" value="{{ $maincate->userid }}">
                                            <table>
                                                <tbody>
                                                    <tr>
                                                        <td style="width:30%">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <input type="text"
                                                                ...
                                                                name="cname" autocomplete="off" value="{{ $maincate->cname }}"
                                                                required
                                                            ...
                                                            <label style="color:red;float:right;">No Special
                                                                Characters</label>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <textarea name="descp" class="form-control @error('description') is-invalid @enderror"
                                                                value="" rows="4" style="font-size: 100%;" required>{{ $maincate->descp }}</textarea>
                                                        </td>
                                                    <tr>
                                                        <td>Banner</td>
                                                        <td>
                                                    ...
                                                    <tr>
                                                   <td> <div class="card-footer ml-auto mr-auto">
                ...
                for (let i = 0; i < input.files.length; i++) {
                    ...
                    reader.onload = function(e) {
                        $('#preview').append('<img src="' + e.target.result +
                            '" class="img-thumbnail mr-2 mb-2" width="100">');
                    };
