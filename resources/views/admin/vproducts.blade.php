                            ...
                            <div class="col-md-12">
                                <div class="card ">
                                    <div class="card-header card-header-success card-header-icon">
                                        ...
                                        <h4 class="card-title">{{ $vdata->title }} <a href="{{ url()->previous() }}"><button class="btn btn-success btn-round" style="float:right">
                                                    ...
                                                    <table class="table">
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    @if(!$vdata->subcategory==null)
                                                                    {{ $vdata->subcategory->title }}
                                                                    @else
                                                                    No Subcategory
                                                                    @endif
                                                                    </td>
                                                            ...
                                                            <tr>
                                                             ...
                                                             <tr>
                                                                ...
                                                                <td>
                                                                    <form method="POST"
                                                                        action="{{ route('app.product', $vdata->id) }}">
                                                                        @csrf
                                                                ...
                                                                <td>
                                                                    <button type="button" rel="tooltip"
                                                                        class="btn btn-warning show_confirm"
                                                                        id="show-user" data-toggle="modal"
                                                                        data-target="#myModal">
                                                                        Not Approve
...
<td>
                                                                    <button type="button"
                                                                        ...
                                                                        <a href="{{route('deditproduct',$vdata->id)}}">Edit</a>
                                            ...
                                            <div class="col-md-6 ml-auto mr-auto text-center">
                                                ...
                                                <img src="{{ url('css/asset/image/' . $vdata->img1) }}"
                                                    style="width: auto;height: 350px; object-fit: scale-down;">
            ...
            <div class="modal" id="myModal" aria-modal="true">
                <div class="modal-content">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <form class="form-horizontal" action="{{route('app.remark',$vdata->id)}}" method="post">
                                @csrf
                                <div class="card ">
                                    <div class="card-header card-header-rose card-header-text">
                                        <div class="card-text" style="padding:8px">
                                            <h4 class="card-title">Remark Of Product</h4>
                                        </div>
                                    </div>
                                    <div class="card-body">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-7">
                                                <div class="form-group">
                                                    ...
                                                    <textarea class="form-control"name="remark"required="required">asfasfas</textarea>
                                                </div>
                                            </div>
