                                                            ...
                                                            <table>
                                                                <tbody>
                                                                    ...
                                                                    <tr>
                                                                        <td>
                                                                            <input id="category" name="category"
                                                                                class="category" type="hidden" value="">
                                                                            <input id="scategory" name="scategory"
                                                                                class="scategory" type="hidden"
                                                                                value="">
                                                                    ...
                                                                    <tr>
                                                                        <td>
                                                                            <input id="category" class="category"
                                                                                name="category" type="hidden" value="">
                                                                            <input id="scategory" class="scategory"
                                                                                name="scategory" type="hidden" value="">
                                                        ...
                                                        <form method="post" action="{{ route('addproduct') }}"
                                                            ...
                                                            <table>
                                                                <tbody>
                                                                    ...
                                                                    <tr>
                                                                        <td>Dynamic Load (Dynamic load is the Static
                                                                            load in
                                                                            motion.)</td>
                                                        ...
                                                        <form method="post" action="{{ route('addproduct') }}"
                                                            ...
                                                            <table>
                                                                <tbody>
                                                                    ...
                                                                    <tr>
                                                                        <td>Equipment to be Used (Required from
                                                                            Prospect)
                                                                        </td>
                                                                        <td><input type="text"
                                                                    ...
                                                                    <tr>
                                                                        <td>Equipment Width (Required from Prospect)
                                                                        </td>
