...
<head>
    ...
    <title>
        MHE Bazar Dashboard Sub Category Footer Content
    </title>
                                                           ...
                                                           <td>
                                                            ...
                                                            <td>
                                                                <button type="submit" rel="tooltip"
                                                                    class="btn btn-sm btn-info float-lg-right"
                                                                    data-original-title="" title="">
                                                                    <a class="text-white"
                                                                        href="{{ route('footerlistes', $blog->id) }}">
