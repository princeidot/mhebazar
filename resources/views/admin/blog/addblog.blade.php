                                    ...
                                    <div class="card-body ">
                                        <form method="post" enctype="multipart/form-data" action="{{route('admin.saveblog')}}" class="form-horizontal">
                                                        ...
                                                        <div class="dropdown bootstrap-select">
                                                            <select class="selectpicker"
                                                                data-style="select-with-transition" 
                                                                  tabindex="-98" title="Chooes Category" name="blog_category">
                                                                @foreach($category as $cate)
                                                                
                                                                <option name="blog_category" value="{{$cate->id}}">{{$cate->name}} </option>
                                                                @endforeach
                                                            </select>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-sm-10">
                                                    <div class="form-group bmd-form-group">
                                                        <input type="text" name="headdescription" class="form-control">
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-sm-10">
                                                    <div class="form-group bmd-form-group">
                                                        <textarea class="form-control" id="summary-ckeditor" rows="4" name="summary-ckeditor"></textarea>
