            ...
            <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top ">
                <div class="container-fluid">
                    <div class="navbar-wrapper">
                        ...
                        <a class="navbar-brand" href="javascript:;">List Sub Admin</a>
                    </div>
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header card-header-icon card-header-rose">
                                    ...
                                    <h4 class="card-title">List Users -
                                        ...
                                        <table class="table">
                                            <thead>
                                             ...
                                             <tbody>
                                               ...
                                               @foreach ($subadmin as $key => $cform)
                                                    <tr>
                                                        ...
                                                        <td class="td-actions text-right">
                                                             ...
                                                             <form method="POST"
                                                                action="{{ route('subadmin.delete', $cform->id) }}">
                                                                @csrf
                                                                <input name="_method" type="hidden" value="DELETE">
                                                                <button type="button" rel="tooltip"
                                                                    class="btn btn-danger btn-lg show_confirm">
                                                                    <i class="material-icons" style="font-size:1.8rem">delete</i>
                                                                </button>
                                                            </form>
                                                            {{-- <form method="POST"
                                                                action="{{ route('proqf.delete', $cform->id) }}" class="d-inline">
                                                                @csrf
                                                                <input name="_method" type="hidden" value="DELETE">
                                                                <button type="button" rel="tooltip"
                                              ...
                                              {{ $subadmin->links('pagination::bootstrap-4') }}
                                         </div>
