            ...
            <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top ">
                <div class="container-fluid">
                    <div class="navbar-wrapper">
                        ...
                        <a class="navbar-brand" href="javascript:;">Vendor Products</a>
                    </div>
                            ...
                            <div class="col-md-12">
                                <div class="card ">
                                    <div class="card-header card-header-success card-header-icon">
                                        ...
                                        <h4 class="card-title">{{ $getdata->name }} <a href="{{ url()->previous() }}"><button class="btn btn-success btn-round" style="float:right">
                                                ...
                                                <div class="table-responsive table-sales">
                                                    <table class="table">
                                                        <tbody>
                                                            ...
                                                            @foreach ($vdata as $key => $pdata)
                                                                <tr>
                                                                    <td>
                                                                       {{ $loop->iteration }}
                                                                    </td>
                                                                    <td>
                                                                        <div class="flag {{ $pdata->apporv == '2' ? 'font-weight-bold' : '' }}">
                                                                            {{ $pdata->title }}
                                                                            <div>
                                                                    </td>
                                                                    ...
                                                                    <td>
                                                                        @if(!$pdata->subcategory==null)
                                                                        {{ $pdata->subcategory->title }}
                                                                        @else
                                                                        No Sub category
                                                                        @endif
                                                                    </td>
                                                                    <td>
                                                                        <div class="flag">
                                                                            <img
                                                                                src="{{ url('css/asset/image/' . $pdata->img1) }}">
                                                                            <div>
                                                                    </td>
                                                                    <td class="td-actions">
                                                                        <button type="button" rel="tooltip"
                                                                            ...
                                                                            <a class="text-white"
                                                                                href="{{ route('dashboard.userproducts', $pdata->id) }}">
